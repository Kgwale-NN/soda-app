  ...
  return (
    ...
    <ContentContainer className={styles['information-container-content']}>
       ...
       <div className={styles.image}>
        ...
        <img src={olipop} alt='Assorted OLIPOP soda flavours' className={styles['olipop-in-pack']}/>
        ...
        <div className={styles['ingredients-info']}>
            ...
            <div className={styles.texts}>
             ...
             <Text variant='h2' style={{color:'rgb(1, 34, 1)'}}>Our Foundational Ingredients</Text>
            ...
            <div className={styles['button-cont']}>
                           ...
                           <a href="#benefits" className={styles.button}>Read More</a>
